    ...
    <div>
      <div>
        <img
          ...
          src="resources/homepage.png"
          alt="mud pot"
        />
        <div className="smallPot">
          <div className="hangingbrownbellture">
            <img
              className="potteryClass"
              src="resources/potteryClass.png"
              alt="mud pot"
            />
            <h4>Water Pots</h4>
            <div className="paragraph">
              <p>Only water pots are containers</p>
              <p>specifically designed for holding </p>
              <p> and storing water.</p>
            </div>
          </div>
          <div className="hangingbrownbellture1">
            <img
              className="designPot"
              src="resources/designPot.png"
              alt="mud pot"
            />
            <h4>Design Pots</h4>
            <div className="paragraph">
              <p>Sleek, minimalist pots with ergonomic</p>
              <p>handles and vibrant colors, blending</p>
              <p>orm and function seamlessly.</p>
            </div>
          </div>
          <div className="hangingbrownbellture2">
            <img
              className="giftCart"
              src="resources/giftCart.png"
              alt="mud pot"
            />
            <h4>Natural Pots</h4>
            <div className="paragraph">
              <p>Natural pots are containers made</p>
              <p>from organic materials found in nature, </p>
              <p>such as clay, wood, or plant fibers.</p>
            </div>
          </div>
          <div className="hangingbrownbellture3">
            <img
              className="potteryWheel"
              src="resources/potteryWheel.png"
              alt="mud pot"
            />
            <h4>Pottery Wheel</h4>
            <div className="paragraph">
              <p>A pottery wheel is a spinning</p>
              <p>device used for shaping clay into </p>
              <p>ceramic objects.</p>
            </div>
          </div>
        </div>
      ...
      <div className="hangingbell">
        <div>
          <img
            className="decorativebell"
            src="resources/decorativeBell.png"
            alt="mud pot"
          />
        </div>
        <div>
      ...
      <div>
        <div className="nextpage">
          <div className="inside">
            {" "}
            <img className="teaset" src="resources/teaSet.jpg" alt="mud pot" />
          </div>
        </div>
        <div className="nextpage1">
          ...
          <p>***</p>
          <p>
            We are a global housewares product design company.<br></br> We bring
            thought and creativity to everyday items<br></br> through original
            design.
          </p>
      ...
      <div>
        <div className="making">
          ...
          <h2>Loyal To Work</h2>
          <p>
            Before starting a pot, a potter is typically very loyal to the work,{" "}
          </p>
        ...
        <div className="making1">
          ...
          <p>
            capturing the artist's essence and narrative within the realm of
            ceramics.
          </p>
        </div>
        <div className="making">
          ...
          <p>
            pure magic, expanding the world of pottery with boundless
            creativity.
          </p>
        </div>
        <div className="making1">
          ...
          <p>
            kaleidoscope of beauty, capturing the essence of artistic
            expression.
          </p>
        </div>
        <div className="making">
          ...
          <p>
            Through the lens of a phone camera, every intricate detail of the
          </p>
          <p>
            pot is captured, preserving its unique essence for all to behold.
          </p>
        </div>
        <div className="making1">
          ...
          <h2>E-Marketplace</h2>
          <p>
            To share the pot online for purchase, showcase its exquisite
        ...
        <div className="making">
          ...
          <h2>Prosperity</h2>
          <p>
            With his exceptional pottery skills, he crafts masterpieces that not
            only{" "}
          </p>
          <p>
            captivate hearts but also pave the way for a prosperous livelihood.
          </p>
        </div>
      </div>
      <div>
